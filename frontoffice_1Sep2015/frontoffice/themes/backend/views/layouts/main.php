...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <!-- Left side content -->
        <div id="leftSide">
            <div class="logo"><a href="<?php echo Yii::app()->createUrl("/ziiadmin"); ?>"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/logo_green_small.png" alt="" /></a></div>
            ...
            <ul id="menu" class="nav">
                ...
                <li class="home2"><a href="#" title="" class="exp"><span>Manage Homepage</span><strong>1</strong></a>
                    <ul class="sub">
                        <li><a href="<?php echo Yii::app()->createUrl("/ziiadmin/manageHomepage/admin"); ?>" title="">Manage Homepage</a></li>                
                    </ul>
                </li>
                ...
                <li class="images"><a href="#" title="" class="exp"><span>Manage Slider Images</span><strong>1</strong></a>
                    <ul class="sub">
						<li><a href="<?php echo Yii::app()->createUrl("/ziiadmin/homepageSlider/create"); ?>" title="">Add Slider Image</a></li>
                        <li><a href="<?php echo Yii::app()->createUrl("/ziiadmin/homepageSlider/admin"); ?>" title="">Manage Homepage Slider</a></li>                
                    </ul>
                </li>
            ...
            <div class="titleArea">
                <div class="wrapper">
                    <div class="pageTitle">
                        <h5>Dashboard</h5>
                        <br />
                        <span><strong>Chhattisgarh :: Single Window Clearance System</strong>.</span>
                    </div>           
                    <div class="clear"></div>
                </div>
            </div>
